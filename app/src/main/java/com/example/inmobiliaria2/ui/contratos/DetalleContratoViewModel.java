...
public class DetalleContratoViewModel extends ViewModel {
    ...
    public void cargarDatos(int idInmueble){
        ...
        Contrato Contrato1=new Contrato(1, LocalDate.parse("2020-01-01"),LocalDate.parse("2020-12-13"),"27678009",inmueble1.getId(),i.getIdInquilino(),inmueble1,i,inmueble1.getPrecio());
        Contrato Contrato2=new Contrato(2, LocalDate.parse("2019-06-01"),LocalDate.parse("2020-04-01"),"34567987",inmueble2.getId(),i2.getIdInquilino(),inmueble2,i2,inmueble2.getPrecio());
